...
@section('content')
    ...
    <div class="container">
        ...
        <div class="col-md-12" style="background-color:  #eaffdf">
            ...
            $doctor_id=DoctorController::generateDoctorID();
            ...
            <h2 style="color: #0a470d;">Register Doctors</h2>
            <br>
                    ...
                    <table>
                        <tr>
                            <td style="width: 30%">
                                <div style="padding-left: 50px">
                                    ...
                                    {{--<div class="form-group">
                                        ...
                                        <div style="width: 50%">
                                            <input type="text" class="form-control" readonly="true" name="doctor_id" value="{{ $doctor_id }}">
                                        </div>
                                    </div>--}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div style="width: 90%">
                                            <select class='form-control select2 select2-hidden-accessible' name='specialty'
                                                    tabindex='-1'
                                                    aria-hidden='true' >"
                                                ...
                                                <option>Endocrinologist/Diabetologist</option>
                                                ...
                                                <option>Neonatal Paediatrician</option>
                                                <option>Neuro Physician</option>
                                                <option>Neuro Physiologist</option>
                                                <option>Neuro Surgeon</option>
                                                <option>Occupational Therapist</option>
                                                <option>Oncological Surgeon</option>
                            ...
                            <td valign="top" style="width: 20%">
                                <div style="padding-top: 100px;padding-left: 100px"><img src="{{ URL::asset('images/doctor.png')}}" class="user-image" alt="User Image" ></div>
                            </td>
                        </tr>
                    </table>
