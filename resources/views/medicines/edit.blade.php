...
@section('content')
    ...
    <div class="container">
        ...
        <div class="col-md-12" style="background-color:  #eaffdf">
            ...
            <h2 style="color: #0a470d">Update medicine {{$medicine->medicine_id}}</h2>
            <br> <br>
            <div class="box box-default">
                <div class="box-header with-border">
                    <div>
                        {!! Form::model($medicine, [
                                                              'method' => 'PATCH',
                                                              'route' => ['medicines.update', $medicine->medicine_id]
                                                          ]) !!}
                        ...
                        {!! Form::submit('Update Medicine', ['class' => 'btn btn-primary']) !!}
