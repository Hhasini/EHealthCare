...
<br><br> <br>
            ...
            <div class="col-md-12" style="background-color:  #eaffdf">
                ...
                <h1 style="color: #0a470d">Create New Schedule</h1>
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    ...
                    {!! Form::open(['route' => 'EC_Schedule.store']) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class='input-group date' id='start_date_picker' style='width:50%;'>
                            <input type='text' class="form-control" name="shift_start" required/>
                ...
                <span class="input-group-addon">
                    ...
                    <div class="form-group">
                        ...
                        <div class='input-group date' id='end_date_picker' style='width:50%;'>
                            <input type='text' class="form-control" name="shift_end" required/>
                <span class="input-group-addon">
                    <span class="glyphicon glyphicon-calendar"></span>
                </span>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <b>Maximum Booking </b><input class="form-control" name="max_bookings" type="text"
                                                          style="width: 50%;" />
                        </div>
